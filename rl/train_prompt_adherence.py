...
def main():
    ...
    # ── Policy model ──────────────────────────────────────────────────
    # set_text_encoder is called inside load_model *before* load_state_dict
    # so that encoder_proj is registered and checkpoint weights load correctly.
    print("\n--- Policy model ---")
